...
export const metadata: Metadata = {
  ...
  title: {
    default: 'De Conil al Mundo | Viajes acompañados desde Conil de la Frontera, Cádiz',
...
const structuredData = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { '@type': 'Offer', itemOffered: { '@type': 'TouristTrip', name: 'Viajes en grupo' } },
      {
        '@type': 'Offer',
      ...
      {
        '@type': 'Offer',
        itemOffered: { '@type': 'TouristTrip', name: 'Circuitos internacionales' },
      },
    ],
  },
  sameAs: [
