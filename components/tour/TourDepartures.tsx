...
function formatRange(dateStr: string, durationDays?: number): { range: string; year: string } {
    ...
    <section className="sec dates band" id="fechas">
      <div className="tp-wrap">
        <div className="head">
          ...
          <h2 className="display">Elige tu <em>fecha</em></h2>
        </div>
        ...
        <p className="date-note">
          Precios por persona en habitación doble. Plazas sujetas a disponibilidad en el momento de
          la reserva. Consulta suplemento de habitación individual.
        </p>
      </div>
    </section>
  )
